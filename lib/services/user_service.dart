...
class UserService {
  final String userUrl = "http://192.168.1.2:3001/api/users/";
  final String authUrl = "http://192.168.1.2:3001/api/auth/";

  Future<dynamic> addUser(name, email, password) async {
    try {
